...
story=[P('류연주','NameK'),P('전시·행사기획자 | 고객경험 | DX·AI','Sub'),P('현장 고객 경험을 이해하고, DX·AI로 전시·행사 운영과 콘텐츠 경험을 개선하는 행사기획자입니다. 전시·박람회·국제행사의 기획부터 현장 운영까지 연결하며, 아날로그 운영의 불편을 디지털 방식으로 개선해 고객과 운영자의 경험을 함께 높입니다.')]

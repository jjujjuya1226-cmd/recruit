...
story=[P('류연주','NameK'),P('전시·행사 프로젝트 기획자 | 현장운영 | 고객경험 | DX·AI','Sub'),P('약 4년간 20여 개 전시·행사를 기획·운영하며 참가자·참가사·운영스탭의 요구를 조율해 왔습니다. 전시 프로젝트를 현장에서 끝까지 실행하고, 콘텐츠와 DX·AI 도구로 운영 과정을 개선하는 전시·행사 프로젝트 기획자입니다.')]
